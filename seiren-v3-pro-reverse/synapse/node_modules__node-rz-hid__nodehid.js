...
function setTimerResolution(resolution) {
    loadBinding();
    binding.setTimerResolution(resolution);
}

function clearTimerResolution() {
    loadBinding();
    binding.clearTimerResolution();
}

function isBatchLightingSupported() {
    return true;
}
...
exports.setTimerResolution = setTimerResolution;
exports.clearTimerResolution = clearTimerResolution;
exports.isBatchLightingSupported = isBatchLightingSupported;
